...
public class DefineMachineGui {
	...
	public static void setupDefineMachineGui() {
		...
		final Tiles.LComboBox<Integer> nrChannels = new Tiles.LComboBox<Integer>("channels", null, false,
				1, 2, 3, 4, 5);

		final Tiles.LComboBox<Integer> nrBands = new Tiles.LComboBox<Integer>("bands", null, false,
				2, 3);
		nrBands.setSelectedIndex(1);

		final Tiles.LComboBox<Integer> nrAngles = new Tiles.LComboBox<Integer>("angles", null, false,
				2, 3, 4, 5);
		nrAngles.setSelectedIndex(1);

		final Tiles.LComboBox<Integer> nrPhases = new Tiles.LComboBox<Integer>("phases", null, false,
				pha3Band);
	...
	public static boolean showOtfParamEditWindow(OtfProvider3D otf, Component base) {
		...
		int retVal = JOptionPane.showConfirmDialog(base, ourPanel, "Edit OTF metadata", JOptionPane.OK_CANCEL_OPTION);
