...
public class FairSimGUI {
	...
	public static SimParam newSpDialog(final Frame baseframe) {
		...
		final Tiles.LComboBox<SimParam.IMGSEQ> imgSeq = new Tiles.LComboBox<SimParam.IMGSEQ>("Type/Img.Seq.",
				SimParam.IMGSEQ.values());
		...
		final Tiles.LComboBox<Integer> nrBands = new Tiles.LComboBox<Integer>("beams", new Integer[] { 2, 3 });
		nrBands.box.setSelectedItem(3);

		final Tiles.LComboBox<Integer> nrDir = new Tiles.LComboBox<Integer>("angles",
				new Integer[] { 1, 2, 3, 4, 5, 6, 7 });
		nrDir.box.setSelectedItem(3);

		final Tiles.LComboBox<Integer> nrPha = new Tiles.LComboBox<Integer>("phases", pha3Band);
