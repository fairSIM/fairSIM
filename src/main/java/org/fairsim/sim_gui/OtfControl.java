...
public class OtfControl {
	...
	void displDialog() {
		 ...
		 * 
		 * for (int i=1; i<optsValue.length; i++) optsLabel[i] =
		 * String.format("a = %5.3f",optsValue[i]);
		 * 
		 * optsValue[0] = 1.;
		 * optsLabel[0] = "Ideal";
		 * 
		 * 
		 * final Tiles.TComboBox<String> comp = new Tiles.TComboBox<String>(optsLabel);
		 * // <-- java 1.7
		...
		final Tiles.TComboBox<OtfProvider.APPROX_TYPE> compType = new Tiles.TComboBox<OtfProvider.APPROX_TYPE>(
				OtfProvider.APPROX_TYPE.values());
