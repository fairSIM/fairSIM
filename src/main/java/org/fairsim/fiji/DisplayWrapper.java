...
public class DisplayWrapper implements ImageDisplay, ImageListener {
	...
	private List<List<ImageDisplay.Marker>> refMarkers = new ArrayList<List<ImageDisplay.Marker>>();

	// list of listeners
	private List<ImageDisplay.Notify> ourListeners = new ArrayList<ImageDisplay.Notify>();
