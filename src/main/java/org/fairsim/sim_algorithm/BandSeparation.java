...
public class BandSeparation {
	 ...
	 * then multiplies the spectra. <br>
	 * Supports arbitrary #phases,
	...
	static public void separateBands(Vec.Cplx[] in, Vec.Cplx[] out,
		...
		for (double i : phases)
			lg += String.format(" %3.2f", i / Math.PI * 180);
		Tool.trace(lg);
