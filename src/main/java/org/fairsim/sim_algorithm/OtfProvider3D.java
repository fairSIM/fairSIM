...
public class OtfProvider3D {
	...
	public Cplx.Float getOtfVal(int band, double xycycl, double zcycl) {
		...
		// TODO: this is a cheap hack, actually the cutoff should be specified
		// seperately for each band
	...
	public void otfToVector(final Vec3d.Cplx vec, final int band,
		...
		// System.out.println(" Cycles: "+vecCyclesPerMicronLateral+"
		// "+vecCyclesPerMicronAxial);
			...
			public void at(int z) {
				for (int y = 0; y < h; y++)
					for (int x = 0; x < w; x++) {
						...
						/*
						 * // TODO: this if statement should not be needed, as getOtfVal has already a
						 * cutoff build in
