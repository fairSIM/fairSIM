...
public final class Vec2d {
	...
	public interface Real extends Vec.Real, Size {
		...
		/**
		 * project (sum along z, from start to end) the real part of a Vec3d into this
		 * vector
		 */
	...
	public static void paste(Vec2d.Real xIn, Vec2d.Real yOut,
		...
		for (int y = 0; y < h; y++)
			for (int x = 0; x < w; x++)
				out[(y + ulyout) * outWidth + (x + ulxout)] = in[(y + ulyin) * inWidth + (x + ulxin)];
	...
	public static void paste(Vec2d.Cplx xIn, Vec2d.Cplx yOut,
		...
		for (int y = 0; y < h; y++)
			for (int x = 0; x < w; x++) {
				out[((y + ulyout) * outWidth + (x + ulxout)) * 2 + 0] = in[((y + ulyin) * inWidth + (x + ulxin)) * 2
						+ 0];
				out[((y + ulyout) * outWidth + (x + ulxout)) * 2 + 1] = in[((y + ulyin) * inWidth + (x + ulxin)) * 2
						+ 1];
